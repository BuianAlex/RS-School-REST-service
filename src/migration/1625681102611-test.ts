...
export class test1625681102611 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "boardColumns" ADD CONSTRAINT "FK_f43a8b1147d375455ec2114ef0c" FOREIGN KEY ("boardIdId") REFERENCES "board"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "boardColumns" DROP CONSTRAINT "FK_f43a8b1147d375455ec2114ef0c"`);
